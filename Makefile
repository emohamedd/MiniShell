...
#    Updated: 2023/09/18 12:16:43 by emohamed         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS =cd.c echo.c env.c exec_cmds.c export.c fell_env_struct.c fill_commands.c from_2d_to_one.c ft_get_env.c ft_split_token.c ft_strdup.c ft_strlen.c get_cmds.c herdo_parse.c make_tokens.c minishell.c pipes.c print_table.c read_input.c redirection.c run_code.c signal_handler.c syntax_err.c token.c unset.c symbol_exec.c
OBJS = $(SRCS:.c=.o)
